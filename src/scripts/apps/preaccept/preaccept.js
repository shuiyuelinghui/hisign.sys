...
export default class PreacceptController {
    ...
    bulidSubmitParams() {
        ...
        this.submitParams.result = this.configData.resultValue == '1' ? '0301' : '0302';
        //判断是否重新预受理
        if (this.flag == '1') {
    ...
    goBack() {
        this.goState('app.task.todo.personal',{pageId:'ap1020'});
    }
    //关闭弹窗
    closePopup() {
