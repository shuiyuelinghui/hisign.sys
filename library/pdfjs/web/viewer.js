...
var DEFAULT_URL = '/library/pdfjs/web/compressed.tracemonkey-pldi-09.pdf';
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/library/pdfjs/web/images/';
  PDFJS.workerSrc = '/library/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/library/pdfjs/web/cmaps/';
...
var PDFViewerApplication = {
  ...
  setTitleUsingUrl: function pdfViewSetTitleUsingUrl(url) {
    ...
    var title = 'title' in params ? params.title : DEFAULT_URL;
    this.setTitle(title);
  },
